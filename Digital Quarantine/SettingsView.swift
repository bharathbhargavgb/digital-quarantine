...
struct SettingsView: View {
    ...
    @State private var enableLaunchAgentInput: Bool = false
    ...
    var body: some View {
        VStack(spacing: 15) {
            ...
            Toggle(isOn: $enableLaunchAgentInput) {
                Text("Start at Login")
            }
            .onChange(of: enableLaunchAgentInput) { isDirty = true }
    ...
    private func loadSettings() {
        ...
        enableLaunchAgentInput = UserDefaults.standard.bool(forKey: kEnableLaunchAgent)
    }
    ...
    private func saveSettings() {
        ...
        if isValid {
            ...
            UserDefaults.standard.set(enableLaunchAgentInput, forKey: kEnableLaunchAgent)
